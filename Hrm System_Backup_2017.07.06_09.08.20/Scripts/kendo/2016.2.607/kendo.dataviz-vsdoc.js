...
kendo.dataviz.Navigator.prototype = {
    ...
    select: function(from,to) {
        ...
        /// </summary>
        /// <param name="from" type="Date" >The from date (inclusive) of the selected date range.</param>
        /// <param name="to" type="Date" >The to date (exclusive) of the selected date range.</param>
